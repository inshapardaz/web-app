module.exports = function (grunt) {
    grunt.initConfig({
        ...
        less: {
            default : {
                files: {
                    'assets/css/custom.css': 'assets/css/custom.less'
                }
            },
            dev_main: {
                options: {
    ...
    grunt.registerTask('default', ['clean:build', 'less:default', 'ts:default', 'concat:build', 'uglify:build', 'copy:build', 'processhtml:build']);
};